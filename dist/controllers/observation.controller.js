...
class ObservationController {
    ...
    getObservationById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                ...
                let dataObservation = yield prisma_1.default.observation.findUnique({
                    where: {
                        id: Number(id),
                    },
                    include: {
                ...
                if (!(dataObservation === null || dataObservation === void 0 ? void 0 : dataObservation.user)) {
                    throw new Error("Observation data is incomplete");
                }
                dataObservation = Object.assign(Object.assign({}, dataObservation), { image: `${req.get("host")}/${dataObservation.image}`, user: dataObservation.user, observationComments: dataObservation.observationComments });
            ...
            try {
                ...
                yield prisma_1.default.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const updateObservation = yield prisma_1.default.observation.update({
                        where: { id: Number(id) },
                        data: Object.assign(Object.assign({}, (((_a = req.file) === null || _a === void 0 ? void 0 : _a.filename)
                    ...
                    yield tx.observationLecturer.update({
                        where: {
